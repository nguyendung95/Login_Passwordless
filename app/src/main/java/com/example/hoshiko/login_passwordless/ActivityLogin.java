package com.example.hoshiko.login_passwordless;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fbLoginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onError(FacebookException error) {
                ...
                Toast.makeText(ActivityLogin.this, toastMessage, Toast.LENGTH_LONG).show();
            }
        });
        // check for an existing access token
        AccessToken accessToken = AccountKit.getCurrentAccessToken();
        com.facebook.AccessToken loginToken = com.facebook.AccessToken.getCurrentAccessToken();
        //Access Token  == null <=> không có người đăng nhập trước đây
        if (accessToken != null || loginToken != null) {
            // Nếu trước đây đã từng đăng nhập thì chuyển ngay tới AccountActivity
            launchAccountActivity();
        }
    }
